...
Motivated and detail-oriented **Data Analyst & BI Developer** with expertise in **SQL, Python, Power BI, Tableau, Advanced Excel, and Applied Statistics**. Proven track record in translating multi-million row transactional datasets and relational schemas into high-impact executive dashboards, normalized database architectures, predictive behavioral segmentations, and actionable commercial strategies. 
...
| **Programming & Scripting** | Python (Pandas, NumPy, SciPy, Seaborn, Matplotlib, SQLAlchemy), Jupyter Notebooks, Automated Data Processing Pipelines |
...
* **Highlights**: Built an RFM scoring pipeline using pandas `qcut` quintiles; classified 8 customer cohorts (Champions driving $3.73M / 16.2% revenue, Loyalists driving $5.12M / 22.2% revenue); built a dual-axis Pareto chart mapping decile spend against cumulative revenue share.
...
* **IBM Data Analytics Professional Certificate** | SQL, Python, Statistics, Power BI, Tableau, Advanced Excel, Applied Generative AI
